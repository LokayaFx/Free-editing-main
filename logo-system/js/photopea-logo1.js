/**
 * Photopea API integration for Logo 1 (all characters)
            ...
            const script = `
                ...
                try {
                    ...
                    function setLayerText(layers, layerName, newText) {
                        ...
                        app.echoToOE("Layer not found: " + layerName);
                        return false;
                    }
...
async function renderLogo(userData) {
    try {
        console.log('=== LOGO GENERATION START ===', userData);

        await renderer.init();
        console.log('Photopea loaded.');

        // Load Muro.otf font (rendering page is at logo-system/rendering/)
        ...
        const psdUrl = `../logo1-char/char${charN}/psd/s1_c${charN}.psd`;
